          ...
          <?php if (!empty($tags)) { ?>
            <?php foreach($tags as $tag){ ?> 
             <tr class="hover:bg-gray-100">
               <td class="border border-gray-300 px-4 py-2 text-center"><?php echo $tag['id'];?></td>
               <td class="border border-gray-300 px-4 py-2"><?php echo $tag['tags'];?></td>
               ...
               <form action="" method="POST">
                 <button type="submit" name="deleteInfo" value="<?= $tag["id"] ?>"  class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 ml-2">Delete</button>
               </form>
              </td>
             </tr>
           <?php };?>
